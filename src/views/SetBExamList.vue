    ...
    /*   {
...

     {
        ...
        },
        {
          ...
          direction:"Direction:",
          displaydirection:"Read each item carefully. CALCULATORS ARE STRICTLY PROHIBITED. You may utilize the margin or the backmost portion of this test for your computation",
          q: '19.	Solve the equation: 3x<sup>2</sup> + 5x + 2 = 0. What are the solutions for x? ',
          answers: [
            {
              text: "A.) x = -1, x = -2/3",
              is_correct: true,
    ...
    
        {
          ...
          direction:"Direction:",
          displaydirection:"Read each item carefully. CALCULATORS ARE STRICTLY PROHIBITED. You may utilize the margin or the backmost portion of this test for your computation",
          q: '22. The What is the value of the expression: (3! + 2! - 1!) ÷ (4! - 2! + 1!)?',
          answers: [
            {
              text: "A.) 1",
              is_correct: false,
...

        {
          ...
          direction:"Direction:",
          displaydirection:"Read each item carefully. CALCULATORS ARE STRICTLY PROHIBITED. You may utilize the margin or the backmost portion of this test for your computation",
          q: '27.	In What is the value of π (pi) approximately?',
          answers: [
            {
              text: "A.) 3.14",
              is_correct: true,
